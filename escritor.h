...
private:
    ...
    */
    bool validar_entero_positivo(char anio);            // Lo pasé a private porque no se tiene que poder acceder desde afuera
...
public:
    ...
    */
    ...
    // Comenté esto porque al final hablamos y esto iria en el Parser, y ademas no se utiliza para las pruebas
